...
/*   Updated: 2022/02/02 15:39:14 by gcollet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap overload operator has been called!" << std::endl;
	if (&src != this)
	{
		_Name = src._Name;
...
void ClapTrap::takeDamage(unsigned int amount) 
{
	_Hitpoints -= amount;
	if (_Hitpoints > 0)
		std::cout << _Name << " take " << amount << " damage and have now " << _Hitpoints << " hitpoints left!" << std::endl;
	else
